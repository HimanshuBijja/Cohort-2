export default function signin(){
    return (
        <div className="flex items-center justify-center h-svh text-center">

            <div className="w-[50%] h-max bg-white flex flex-col gap-2 py-6 px-4 rounded-2xl">
                <h1 className="text-4xl mb-10">Sign in</h1>
                <InputBox label={"Username"} placeholder="abc@123"/>
                <InputBox label={"Password"} placeholder="Xyz"/>
                <button className="border-2 p-2 rounded-2xl bg-slate-900 text-amber-100">Sign in</button>
